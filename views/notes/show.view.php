...
<?php require base_path(('views/partial/banner.php')); ?>
  ...
  <main>
    ...
    <p class = "mb-6"> <a href ="/notes" class ="text-blue-500 undeline" > go back </a> </p>
        ...
        <footer class = "mt-6">
          <a href="/note/edit?id=<?= $note['id'] ?>" class = "rounded-md bg-gray-500 
          px-3 py-2 text-sm font-semibold text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500" >
           Edit </a>
        </footer>
    </div>
  </main>
