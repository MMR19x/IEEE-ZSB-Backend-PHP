      ...
      <div class="flex h-16 items-center justify-between">
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/" class="<?= URLIs('/') ? 'bg-gray-950 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Home</a>
              <a href="/about" aria-current="page" class="<?= URLIs('/about') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">About</a>
              <?php if($_SESSION['user'] ?? false) : ?>
              <a href="/notes" aria-current="page" class="<?= URLIs('/notes') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Notes</a>
              <?php endif ?>             
        ...
        <div class="hidden md:block">
          <div class="ml-4 flex items-center md:ml-6">
            ...
            <?php else : ?>
              <a href="/register" class="relative ml-3 inline-flex items-center rounded-full bg-gray-800 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">Register</a>
              <a href="/login" class="relative ml-3 inline-flex items-center rounded-full bg-gray-800 px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white focus:outline-2 focus:outline-offset-2 focus:outline-indigo-500">Log In</a>
